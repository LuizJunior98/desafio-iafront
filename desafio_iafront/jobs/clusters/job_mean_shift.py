...
from desafio_iafront.jobs.clusters.clusters import mean_shift
...
def main(dataset: str, saida: str, data_inicial, data_final):
    ...
    coordinates, labels = mean_shift(vector)
